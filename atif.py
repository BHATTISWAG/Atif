...
\033[1;91m➣ \033[1;92mFACEBOOK   :            ATIF MEHMOOD
...
\033[1;92m➣ FACEBOOK    :        ATIF MEHMOOD
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:SWAG BHATTI 
	    time.sleep(2)
            loop = 'false'
        else:
...
def action():
    ...
    jalan("Note : Your CP Accounts Will Open after  7 days")
    print ''
    print """
